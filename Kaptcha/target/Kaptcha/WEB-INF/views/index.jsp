...
<div class="main">
    <div class="login">
        <div class="log-con">
            <span>登录</span>
            <form class="log-con" action="${pageContext.request.contextPath}/login">
...
<%--            <input type="button" id="code" onClick="change();">--%>
            <img id="img" src="${pageContext.request.contextPath}/getVc" style="height: 44px; width: 94px ;">
             <button id="myButton" type="submit" style="display: none"></button>
            </form>
            <a id="toLogin">立即登录</a>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $("#img").click(function () {
        this.src="${pageContext.request.contextPath}/getVc?"+Math.random();
    })
