...
@WebServlet("/CustomerJsonListServlet")
public class CustomerJsonListServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Page page = customerService.getCustomerPage(Integer.parseInt(pn),Integer.parseInt(ps));
        //以json的形式发送给前端页面
