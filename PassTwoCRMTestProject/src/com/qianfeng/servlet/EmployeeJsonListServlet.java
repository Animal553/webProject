...
@WebServlet("/EmployeeJsonListServlet")
public class EmployeeJsonListServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Page page = employeeService.getEmployeePage(Integer.parseInt(pn),Integer.parseInt(ps));
        //以json的形式发送给前端页面
