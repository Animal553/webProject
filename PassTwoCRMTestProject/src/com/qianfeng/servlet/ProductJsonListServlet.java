...
@WebServlet("/ProductJsonListServlet")
public class ProductJsonListServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Page page = productService.getProductPage(Integer.parseInt(pn),Integer.parseInt(ps));
        //以json的形式发送给前端页面
