...
@WebServlet("/InternationalJsonListServlet")
public class InternationalJsonListServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Page page = customerService.getInternationalPage(Integer.parseInt(pn),Integer.parseInt(ps));
        //以json的形式发送给前端页面
