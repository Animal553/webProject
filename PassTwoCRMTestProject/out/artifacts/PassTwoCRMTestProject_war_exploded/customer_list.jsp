                            ...
                            <div class="card-toolbar clearfix">
                                <form class="pull-right search-bar" role="form">
                                    <div class="input-group">
                                        <input type="text" id="K" class="form-control" name="keyword" onchange="getName()" placeholder="请输入客户名称">
                                ...
                                <div class="toolbar-btn-action">
                                    <a class="btn btn-primary m-r-5" href="${pageContext.request.contextPath}/CustomerToAddServlet"><i class="mdi mdi-plus"></i> 新增</a>
...
<script>
    ...
    $.getJSON("CustomerJsonListServlet",{pageNo:pageNo,pageSize:pageSize},function (d) {
        console.log(d);
        ...
        for (var i=0;i<list.length;i++){
            str+="<tr>\r\n" +
                ...
                "<td>\r\n" +
                " <div class=\"btn-group\">"+
                "	<a class=\"btn btn-xs btn-default\"  title=\"编辑\" data-toggle=\"tooltip\" href=\"${pageContext.request.contextPath }/CustomerToUpdateServlet?customerId="+list[i].customerId+" \"> <i class=\"mdi mdi-pencil\"></i></a>\r\n" +
        ...
        $.getJSON("DepartmentLikeSelectServlet",{kname:kname},function (date) {
            ...
            for (var i=0;i<list.length;i++){
                str+="<tr>\r\n" +
                    ...
                    "<td>\r\n" +
                    " <div class=\"btn-group\">"+
                    "	<a class=\"btn btn-xs btn-default\"  title=\"编辑\" data-toggle=\"tooltip\" href=\"${pageContext.request.contextPath }/CustomerToUpdateServlet?customerId="+date[i].customerId+" \"> <i class=\"mdi mdi-pencil\"></i></a>\r\n" +
